        ...
        <div className="max-w-md w-full mx-auto">
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-400">
              Join us to start building amazing things with Lumina UI.
            </p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSignUp}>
            ...
            <Button type="submit" variant="glow" className="w-full mt-6" size="lg">
              Create Account
            </Button>
          </form>
          ...
          <div className="my-8 flex items-center">
            ...
            <span className="px-4 text-xs text-slate-500 uppercase tracking-wider font-semibold">Or register with</span>
            <div className="flex-grow border-t border-slate-800"></div>
          </div>
          ...
          <p className="mt-10 text-center text-sm text-slate-400">
            ...
            <Link to="/login" className="text-white hover:text-indigo-300 transition-colors font-medium">
              Sign in
            </Link>
          </p>
        </div>
